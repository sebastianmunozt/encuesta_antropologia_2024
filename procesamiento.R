...
#df <- df %>%
# mutate(respuesta_recod = case_when(
# respuesta %in% c("Categoria A", "Categoria D") ~ "Grupo 1",
# respuesta %in% c("Categoria B", "Categoria E") ~ "Grupo 2",
# respuesta %in% c("Categoria C", "Categoria F") ~ "Grupo 3"))
